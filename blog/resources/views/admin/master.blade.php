...
<head>
    ...
    {{-- Datepicker --}}
    <link rel="stylesheet" type="text/css" href="{!! url('public/datepicker/jquery-ui.js') !!}">
    <link rel="stylesheet" type="text/css" href="{!! url('public/datepicker/jquery-ui.min.js') !!}">
</head>
